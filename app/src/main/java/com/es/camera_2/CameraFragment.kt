...
class CameraFragment : Fragment(), View.OnClickListener, CameraContract.View, CoroutineScope {
    ...
    private val onImageAvailableListener = ImageReader.OnImageAvailableListener {
        launch(coroutineContext) {
            file = File(activity?.getExternalFilesDir(null), "visual" + System.currentTimeMillis())
...
//                        cameraDevice = manager.withOpenCamera(cameraId)
//                        Log.i("withOpenCamera", "camera : $cameraDevice")
//                        cameraDevice?.let {
////                            withMainContext{
////                                createCameraPreviewSession()
////                            }
